...
<template>
  <div>
    <div
      class="bg-[#ffffff] dark:bg-[#2B2B2B] px-4 pt-3 pb-4 rounded shadow border-indigo-500"
    >
    ...
    <div class="mt-3 grid grid-cols-1 md:!grid-cols-3 gap-4">
      ...
      <div
        class="bg-[#ffffff] dark:bg-[#2B2B2B] rounded shadow relative overflow-auto"
      >
      ...
      <div
        class="bg-[#ffffff] dark:bg-[#2B2B2B] rounded shadow overflow-x-auto"
      >
    ...
    <div
      ...
      class="mt-5 bg-[#ffffff] dark:bg-[#2B2B2B] shadow rounded p-4"
    >
    ...
    <div class="mt-5 bg-[#ffffff] dark:bg-[#2B2B2B] shadow rounded p-4">
      <div class="text-lg mb-4 font-semibold">
